...
public class EntityValidator {
    private final Map<Integer, User> inMemoryUserMap;

    @Autowired
    public EntityValidator(InMemoryUserStorage inMemoryUserStorage) {
        this.inMemoryUserMap = inMemoryUserStorage.getEntityMap();
    }

    public void validateUser(User user, String conclusion) {
        String excMsg = "";
    ...
    public void validateItem(Item item, Boolean isUpdate, String conclusion) {
        String excMsg = "";
