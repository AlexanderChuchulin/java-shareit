...
public class ItemServiceCrudTests {
    ...
    void itemServiceReadTests() {
        ...
        //getAllByOwnerId
        when(mockItemJpaRepository.findAllByOwnerUserIdOrderByItemIdAsc(any(), any())).thenReturn(Page.empty());
        itemService.getEntityService(null, 1L, "0", "10");
        Mockito.verify(mockItemJpaRepository, Mockito.times(1)).findAllByOwnerUserIdOrderByItemIdAsc(any(), any());
    }
