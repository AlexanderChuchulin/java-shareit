...
public class OtherUtils {
    ...
    public static Pageable pageableCreateFrommAdditionalParams(String[] additionalParams, long pageSize, String... sortParam) {
        ...
        if (Integer.parseInt(additionalParams[0]) < 0 || additionalParams[1] != null
                && !additionalParams[1].isBlank() && Integer.parseInt(additionalParams[1]) <= 0) {
        ...
        if (additionalParams[1] == null || additionalParams[1].isBlank()) {
            size = pageSize;
            page = 0;
        } else {
